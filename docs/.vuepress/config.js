...
module.exports = {
  ...
  title: "fish-cloud",
  description: 'Fish-Cloud 微服务快速系统',
  // base: '/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'theme-color', content: '#11a8cd' }], // 移动浏览器主题颜色
    ['meta', { name: 'keywords', content: 'SpringCloud,分布式微服务,fishCloud,ELADMIN'}]
  ...
  themeConfig: {
    ...
    repo: 'lyn4ever29/fish-cloud', // 导航栏右侧生成Github链接
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:lyn4ever29@jhacker.cn'
        },
        {
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'Lyn4ever | LICENSE-2.0', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
